<nav id="checkRoomNav" class="flex 2xl:flex-row xl:flex-row lg:flex-row 2xl:9/12 xl:w-10/12 lg:w-11/12  w-11/12 flex-col mx-auto items-center justify-between  translate-x-1/2 right-1/2 gap-5 absolute shadow-inner bg-slate-50 p-2 text-slate-900">
    ...
    <div class=" 2xl:w-72 xl:w-72 lg:w-72 w-full flex flex-col gap-2 justify-between">
        ...
        <select name="city" id="" aria-placeholder="City" class=" w-full border-none  ">
...
<div id="date-range-picker" date-rangepicker class="flex 2xl:w-72 xl:w-72 lg:w-72 w-full items-center">
  ...
  <div class="2xl:w-72 xl:w-72 lg:w-72 w-full flex flex-col justify-between gap-2">
    <h1 class="text-sm font-bold" style="color:{{ env('COLOR_1'); }}">Guest</h1>

  <input type="number" name="guest" placeholder="guest" class=" w-full px-2 py-2 rounded-md border border-slate-900" />
</div>
