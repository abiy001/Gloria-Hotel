...
<body class="pb-4">
 ...
 <div class=" container relative mx-auto p-4 flex flex-col gap-5 2xl:w-9/12 xl:w-9/12 lg:w-9/12 w-full h-[300px] overflow-y-auto scrollbar-hide min-h-screen">
    <div class=" flex flex-col gap-3 font-bold">
        <img class="w-full max-h-[550px]" src=" {{ url('/images/hotels/hotel1.jpg') }}" alt="">
        <h1 style="color: {{ env('COLOR_1') }}" class=" uppercase 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-2xl text-2xl">{{ $roomtype -> roomtype_name }}</h1>
    </div>

    <div class=" flex flex-col gap-4">
        <div class=" flex flex-row items-center justify-between">
            <h1 style="" class=" text-slate-900 font-semibold text-3xl"> Rp. {{ number_format($roomtype-> price_per_day, 0, ',', '.') }}  </h1>
